...
const allAvatarFiles = [
  ...
  'media_1787137006143.png', // 11
  'media_1787137155567.png', // 12
  'media_1787137160162.png', // 13
  'media_1787137168518.png', // 14
  'media_1787137176082.png'  // 15
];

async function main() {
  console.log('=== COPYING ALL 15 USER AVATAR IMAGES ===');
  ...
  console.log('\n=== UPDATING ALL 16 TESTIMONIALS IN DB WITH 15 REAL AVATARS ===');
  ...
  console.log('\n=== ALL TESTIMONIALS UPDATED IN DATABASE ===');
}
