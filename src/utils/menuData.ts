...
export const SIGNATURE_DISHES: Dish[] = [
  ...
  {
    id: 'start-5',
    name: 'Schezwan Manchuria',
    teluguName: 'షెజ్వాన్ మంచూరియా',
  ...
  {
    id: 'start-7',
    name: 'Soya Chaap Manchuria',
    teluguName: 'సోయా చాప్ మంచూరియా',
  ...
  },
  {
    ...
    teluguName: 'బేబీ కార్న్ మంచూరియా',
  ...
  },
  {
    ...
    teluguName: 'బేబీ కార్న్ మెజెస్టిక్',
  ...
  },
  {
    ...
    teluguName: 'తందూరి పనీర్ టిక్కా',
  ...
  // =================== SPECIAL STARTERS (12 items) ===================
  {
    id: 'splstart-1',
    name: 'French Fries',
    teluguName: 'ఫ్రెంచ్ ఫ్రైస్',
  ...
  },
  {
    ...
    teluguName: 'హనీ చిల్లీ పొటాటో',
    description: 'Crispy finger potatoes tossed in a sweet, sticky honey and spicy red chili glaze.',
    price: '₹350',
    category: 'Special Starters',
  ...
  },
  {
    ...
    teluguName: 'క్రిస్పీ బేబీ కార్న్',
  ...
  {
    id: 'splstart-4',
    name: 'Mushroom Butter Pepper',
    teluguName: 'మష్రూమ్ బటర్ పెప్పర్',
    description: 'Fresh mushrooms stir-fried in a rich butter glaze with black pepper and herbs.',
    price: '₹320',
    category: 'Special Starters',
  ...
  {
    id: 'splstart-5',
    name: 'Sangrila Paneer',
    teluguName: 'సాంగ్రిల్లా పనీర్',
  ...
  },
  {
    id: 'splstart-8',
    name: 'Narmada Paneer',
    teluguName: 'నర్మద పనీర్',
    description: 'Premium chef special paneer starter prepared with signature aromatic spices.',
    price: '₹350',
    category: 'Special Starters',
  ...
  },
  {
    ...
    teluguName: 'వెజ్ స్ప్రింగ్ రోల్',
  ...
  {
    id: 'splstart-11',
    name: 'Chilkur Special Paneer',
    teluguName: 'చిల్కూరు స్పెషల్ పనీర్',
  ...
  {
    id: 'splstart-12',
    name: 'Chilkur Special Veg',
    teluguName: 'చిల్కూరు స్పెషల్ వెజ్',
...
export const GALLERY_PHOTOS = [
  ...
  { id: 'g34', src: '/bundi-raita.jpg',                title: 'Bundi Raita',                 menuCategory: 'Raita',           menuDishName: 'Boondi Raita' },
  { id: 'g35', src: '/navratan-pulao.jpg',             title: 'Navratan Pulao',              menuCategory: 'Pulao',           menuDishName: 'Navratan Pulao (Sweet)' },
];
